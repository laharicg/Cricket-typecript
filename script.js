var Teams = /** @class */ (function () {
    function Teams(tName1, tName2) {
        this.teamname1 = tName1;
        this.teamname2 = tName2;
        for (var i = 1; i < 3; i++) {
            if (i == 1) {
                var lb1 = document.createElement("h3");
...
function playerHit() {
    ...
    for (var index = 1; index < 7; index++) {
        var cellIndex = originalPlayer + index;
...
var buildgame = function () {
    ...
    var tn1 = document.getElementById("t1").value;
    var tn2 = document.getElementById("t2").value;
    var newgame = new Team(tn1, tn2);
};
